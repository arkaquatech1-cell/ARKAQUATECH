...
export default async function BlogsPage() {
      ...
      <main className="min-h-screen bg-white">
        <section className="flex min-h-[70vh] items-center justify-center px-4">
          <div className="text-center">
            <h1 className="text-3xl font-black text-[#021B2F]">
  ...
  const featuredBlog =
    publishedBlogs.find((blog) => blog.featured) ||
    publishedBlogs[0];
      ...
      {publishedBlogs.length === 0 ? (
        <section className="py-24">
          <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
            ...
            <div className="rounded-[35px] border border-slate-100 bg-[#F8FBFE] p-12">

              <Fish className="mx-auto h-12 w-12 text-[#0A6EBD]" />

              <h2 className="mt-6 text-3xl font-black text-[#021B2F]">
                ...
                <article className="group grid overflow-hidden rounded-[35px] border border-slate-100 bg-[#F8FBFE] lg:grid-cols-2">
                  ...
                  <div className="relative min-h-[350px] overflow-hidden lg:min-h-[520px]">
                    ...
                    {featuredBlog.image_url ? (
                      ...
                      <div className="flex h-full min-h-[350px] items-center justify-center bg-slate-100 lg:min-h-[520px]">
                        <Fish className="h-16 w-16 text-[#0A6EBD]/40" />
                      </div>
                    )}
                        ...
                        >
                          ...
                          {blog.image_url ? (
                            ...
                            <div className="flex h-full items-center justify-center bg-slate-100">
                              <Icon className="h-14 w-14 text-[#0A6EBD]/40" />
                            </div>
                          )}
