...
export const metadata = {
  title:
    "Biofloc Fish Farming Services | ARK AQUATECH",
  description:
    "ARK AQUATECH provides advanced Biofloc fish farming systems, oxygen balancing, smart aquaculture engineering, pond aeration, and sustainable fish farming solutions in India.",
};
        ...
        <div className="max-w-7xl mx-auto grid gap-16 lg:grid-cols-2 items-center">
          ...
          <div>
            ...
            >
              ...
              Biofloc fish farming systems for
              sustainable aquaculture production,
              oxygen balancing,
              smart pond management,
              and high-efficiency fish farming solutions.
            </p>
