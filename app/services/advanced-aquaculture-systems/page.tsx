...
export const metadata = {
  title:
    "Advanced Aquaculture Systems | ARK AQUATECH",
  description:
    "ARK AQUATECH provides advanced aquaculture systems including aeration systems, HDPE pond lining, smart automation, oxygen management, and sustainable aquaculture engineering solutions in India.",
};
        ...
        <div className="max-w-7xl mx-auto grid gap-16 lg:grid-cols-2 items-center">
          ...
          <div>
            ...
            >
              ...
              including smart automation,
              aeration systems,
              HDPE pond lining,
              oxygen balancing,
              and sustainable aquatic infrastructure
              for commercial fish farming projects.
            </p>
          ...
          >
            <Image
              ...
              alt="Advanced Aquaculture Systems"
              width={1200}
              height={1200}
              className="
                h-[500px]
